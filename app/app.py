...
def apiDeteksi():
	...
	if filename != '':
		...
		if file_ext in app.config['UPLOAD_EXTENSIONS']:
			...
			#hasil_prediksi = str(y_pred_test_single)

			if y_pred_test_single[0] > 0.1:
				hasil_prediksi = "Tumor"
			else :
				hasil_prediksi = "No Tumor"
...
if __name__ == '__main__':
	...
	model = make_model()
	model.load_weights("model_brain.h5")
